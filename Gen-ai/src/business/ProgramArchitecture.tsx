        ...
        <section id="programs" className="responsive-section program-architecture-section relative pb-32 flex flex-col items-center h-auto xl:h-[700px] pt-10" style={{ height: '700px', paddingTop: '40px' }}>
            <div className="relative w-full max-w-[1233px] flex flex-col items-center justify-start">
                ...
                <div className="arch-header-group" style={{
                    ...
                    <div className="arch-header-inner" style={{
                        display: 'flex',
                        flexDirection: 'column',
                        alignItems: 'center',
                        padding: '0px',
                        ...
                        <div className="arch-tag-wrapper" style={{
                            display: 'flex',
                            flexDirection: 'column',
                            alignItems: 'center',
                            padding: '0px',
                        ...
                        <div className="arch-title-wrapper" style={{
                            display: 'flex',
                            flexDirection: 'column',
                            alignItems: 'center',
                            padding: '0px',
                            ...
                            <h2 className="arch-title-heading" style={{
                                width: 'auto',
                                height: 'auto',
                                minHeight: '60px',
                                whiteSpace: 'nowrap',
