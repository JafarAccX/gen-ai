...
function SatCard({ card }: { card: SaturdayCard }) {
  ...
  const cardBackground = card.highlighted || isHovered
    ? 'linear-gradient(180deg, rgba(246,246,245,0.95) 0%, rgba(197,163,130,0.7) 100%)'
    : 'linear-gradient(180deg, rgba(255,247,239,0.85) 0%, rgba(210,197,185,0.6) 100%)';
  ...
  const cardBorder = card.highlighted
    ? '1px solid rgba(202, 85, 9, 0.35)'
    : isHovered
      ? '1px solid rgba(202, 85, 9, 0.45)'
      : '1px solid rgba(150, 67, 13, 0.18)';
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          position: 'relative',
          borderRadius: '12px',
          background: 'linear-gradient(180deg, rgba(246,246,245,0.9) 0%, rgba(210,197,185,0.5) 100%)',
          border: '1px solid rgba(150, 67, 13, 0.18)',
          padding: '16px 0',
          flexDirection: 'column',
          gap: '14px',
        }}
