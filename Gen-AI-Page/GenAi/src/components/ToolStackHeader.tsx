...
export default function ToolStackHeader() {
  return (
    <div
      className="responsive-section tool-stack-header-section"
      style={{
        boxSizing: 'border-box',
        display: 'flex',
        flexDirection: 'column',
        alignItems: 'center', // visually centered
        padding: '0px',
        gap: '24px',
        position: 'absolute',
        width: '1239px',
        height: '140px',
        left: 'calc(50% - 1239px / 2)', // Centered horizontally (matches left: 101px on 1440px canvas)
        top: '7450px', // Placed perfectly below the Mentors Profile section
        zIndex: 10,
      }}
    >
