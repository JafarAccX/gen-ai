export default function TrackBadge() {
  return (
    <div
      className="hidden xl:flex flex-row items-start absolute box-border rounded-[25px] select-none pointer-events-none z-[60] whitespace-nowrap track-badge-desktop"
      style={{
        padding: '4px 12px',
        width: 'fit-content',
        height: '25px',
