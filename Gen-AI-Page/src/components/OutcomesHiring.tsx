    ...
    >
      ...
      >
        ...
        >
          ...
          {/* Row 1 */}
          <div className="hiring-table-row" style={{ boxSizing: 'border-box', display: 'grid', gridTemplateColumns: '1fr 120px 130px', alignItems: 'center', padding: '10px 0px', width: '100%', borderBottom: '1px solid rgba(255, 255, 255, 0.05)' }}>
          ...
          {/* Row 5 */}
          <div className="hiring-table-row" style={{ boxSizing: 'border-box', display: 'grid', gridTemplateColumns: '1fr 120px 130px', alignItems: 'center', padding: '10px 0px', width: '100%' }}>
        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', width: '100%' }}>
            {/* Item 1 */}
            <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'flex-start', padding: '0px 0px 0.685px', gap: '6px', width: '100%' }}>
            ...
            {/* Item 2 */}
            <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'flex-start', padding: '0px', gap: '6px', width: '100%' }}>
              <div style={{ paddingTop: '6px', flexShrink: 0 }}><CheckIcon /></div>
              <div style={{ fontFamily: 'Inter', fontWeight: 400, fontSize: '16px', lineHeight: '31px', color: '#E5E2E1', flex: 1 }}>
