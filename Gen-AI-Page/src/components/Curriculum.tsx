    ...
    >
      ...
      <div className="flex flex-col items-center p-0 gap-[20px] w-full max-w-[1188px] flex-none order-0 grow-0">
        ...
        <div className="flex flex-col items-center p-0 w-full flex-none order-1 self-stretch grow-0">
          <h2 className="w-full max-w-[1041px] font-['Inter'] font-medium text-[24px] md:text-[32px] leading-[1.3] md:leading-[60px] flex items-center justify-center text-center text-[#F5F7FF] flex-none order-0 grow-0 px-4 lg:px-0">
      ...
      {/* Subheading */}
      <p className="w-full max-w-[1188px] font-['Inter'] font-medium text-[14px] md:text-[16px] leading-[19px] text-center text-[#C2C2C2] flex-none order-1 grow-0 -mt-[24px] px-4 lg:px-0">
          ...
          return (
            <div
              ...
              style={{
                ...
                borderTop: (isOpen || isHovered)
                  ? '2px solid rgba(252, 100, 1, 0.6)'
                  : '2px solid rgba(252, 100, 1, 0.15)',
            ...
            >
              ...
              <div className="curriculum-row-head" style={{
                ...
                <div className="curriculum-tags" style={{
                  display: 'flex',
                  flexDirection: 'row',
                  alignItems: 'center',
                  gap: '8px',
              ...
              {isOpen && (
                <div style={{
                  ...
                  <div className="curriculum-tags-mobile" style={{
                    display: 'none',
                    flexDirection: 'row',
                    flexWrap: 'wrap',
                    gap: '8px',
                  ...
                  <div style={{
                    ...
                    <div>
                      ...
                      <span style={{ color: '#A0A8B8', fontWeight: 500 }}>{module.goal}</span>
                    </div>
                    <div>
                      ...
                      <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
                        {module.sessions.map((session, sIdx) => (
                          <div key={sIdx} style={{ display: 'flex', flexDirection: 'row', alignItems: 'flex-start', gap: '8px' }}>
                            ...
                            <span style={{ color: '#A0A8B8', fontWeight: 500 }}>{session}</span>
                          </div>
                        ))}
                      </div>
                    </div>
