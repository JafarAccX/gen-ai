...
export default function ProgramArchitecture() {
    return (
        <section id="programs" className="relative pb-32 flex flex-col items-center w-[100%] max-w-[1440px] px-4 mx-auto" style={{
            minHeight: '561px',
            height: 'auto',
            paddingTop: '60px',
            paddingBottom: '80px',
            ...
            <div className="relative w-full max-w-[1320px] flex flex-col items-center justify-start">
                ...
                {/* Phase Cards — Mobile Marquee (same card structure as desktop) */}
